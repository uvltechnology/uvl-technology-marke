              ...
              return (
                <motion.div key={index} variants={fadeInUp}>
                  <Card className="overflow-hidden border-2 border-border/50 hover:border-galactic-violet/30 transition-all">
                    <div className="bg-gradient-to-r from-galactic-violet/5 to-electric-purple/5 border-b border-border p-8">
                      <div className="flex flex-col md:flex-row md:items-center gap-6 mb-6">
                        <div className="w-16 h-16 bg-galaxy-gradient rounded-2xl flex items-center justify-center flex-shrink-0 shadow-xl">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            {study.results.map((result, idx) => (
                              <div key={idx} className="bg-gradient-to-br from-galactic-violet/10 to-electric-purple/10 p-4 rounded-xl border border-galactic-violet/20">
